"""
Django settings for BlackMamba project.
...
SECRET_KEY = ')s-+h))ngfhjy)k_p#^eld^!^q^=x_j7^--t#(nvxecj1iixjq'
...
# added by luo1fly for rest_framework installation
...
WSGI_APPLICATION = 'BlackMamba.wsgi.application'
